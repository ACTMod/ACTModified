...
# 4. Open Firewall rules
    ...
    $Content = "Allow_ICMPv4_in -Action Allow -Enabled True -Profile Any -Protocol ICMPv4"
    ...
    $Content = "Allow_iPerf3_in -Action Allow -Enabled True -Profile Any -Protocol TCP -LocalPort " + $iPerfFWPort
    Add-Content -Path $File -Value $Content